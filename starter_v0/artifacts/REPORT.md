...
- Chức năng mở rộng ngoài luồng cơ bản (nếu có; tối đa 10 trong tổng 100 điểm): `check_ticket_status` — tra cứu tiến độ một ticket đã tồn tại, do Người 3 tự xây (xem B5).
